...
import { solveDoubleSquareWellAnalytical } from "./analytical-solutions/double-square-well.js";
    ...
    switch (wellParams.type) {
      ...
      case PotentialType.DOUBLE_SQUARE_WELL:
        if (
          ...
          // Use analytical solution by default (most accurate and fastest)
          ...
          // Note: Numerical methods available as fallback if needed:
          // - solveDoubleWellNumerov() for Numerov method
          // - this.solveNumerical() for DVR/FGH/Spectral methods
        }
        break;
