/**
 * Test DVR with NEGATIVE kinetic energy (as it should be!)
 */
...
function createKineticEnergyMatrix(N, dx, mass) {
  // NOTE: Negative sign because T = -ℏ²/(2m) · d²/dx²
...
function testDVR_WithNegativeKE() {
  console.log('\n=== DVR with NEGATIVE Kinetic Energy (Correct!) ===\n');
  ...
  console.log(`First point: ${xGrid[0].toExponential(4)} m, Last: ${xGrid[numPoints-1].toExponential(4)} m`);
...
const result = testDVR_WithNegativeKE();
